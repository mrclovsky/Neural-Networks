...
def zad2_two_layer_net(student_id):
    ...
    model.hidden_layer.W[:, 0] = [0.5, 0]      # wagi neuronu h1
    model.hidden_layer.W[:, 1] = [-0.5, 0]      # wagi neuronu h2
    model.hidden_layer.b[:] = [0, 0.4]         # biasy neuronów h1 i h2
    model.output_layer.W[:, 0] = [0.5, 0.5]      # wagi neuronu wyjściowego
    model.output_layer.b[:] = [-0.8]         # bias neuronu wyjściowego
...
if __name__ == '__main__':
    ...
    student_id = 188724         # Twój numer indeksu, np. 102247
